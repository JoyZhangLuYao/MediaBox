...
/** 
 * DAO for table "C_MUSIC_TABLE".
*/
public class CollectMusicFileInfoDao extends AbstractDao<CollectMusicFileInfo, Long> {

    public static final String TABLENAME = "C_MUSIC_TABLE";

    /**
     * Properties of entity CollectMusicFileInfo.<br/>
    ...
    */
    ...
    public CollectMusicFileInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CollectMusicFileInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"C_MUSIC_TABLE\" (" + //
                ...
                "\"BUF\" BLOB);"); // 6: buf
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_C_MUSIC_TABLE_NAME_DESC ON C_MUSIC_TABLE" +
                " (\"NAME\" DESC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"C_MUSIC_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CollectMusicFileInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CollectMusicFileInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CollectMusicFileInfo readEntity(Cursor cursor, int offset) {
        CollectMusicFileInfo entity = new CollectMusicFileInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CollectMusicFileInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CollectMusicFileInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CollectMusicFileInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
