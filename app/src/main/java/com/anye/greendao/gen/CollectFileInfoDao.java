...
/** 
 * DAO for table "C_VODEO_TABLE".
*/
public class CollectFileInfoDao extends AbstractDao<CollectFileInfo, Long> {

    public static final String TABLENAME = "C_VODEO_TABLE";

    /**
     * Properties of entity CollectFileInfo.<br/>
    ...
    */
    ...
    public CollectFileInfoDao(DaoConfig config) {
        super(config);
    }
    
    public CollectFileInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"C_VODEO_TABLE\" (" + //
                ...
                "\"BUF\" BLOB);"); // 6: buf
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_C_VODEO_TABLE_NAME_DESC ON C_VODEO_TABLE" +
                " (\"NAME\" DESC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"C_VODEO_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CollectFileInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CollectFileInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public CollectFileInfo readEntity(Cursor cursor, int offset) {
        CollectFileInfo entity = new CollectFileInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, CollectFileInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CollectFileInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CollectFileInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
