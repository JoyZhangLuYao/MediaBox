...
public class ArcProgress extends ProgressBar {
    ...
    //未填充部分颜色
    private final int DEFAULT_mUnmProgressColor = 0x00eaeaea;
    private final int DEFAULT_mProgressColor = Color.parseColor("#99E4592C");
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mArcPaint.setStrokeWidth(mBoardWidth-4);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        // 设置画笔的颜色
        paint.setColor(Color.parseColor("#E4592C"));
        // 设置paint的外框宽度
        paint.setStrokeWidth(3);
        canvas.drawCircle(x, y, mRadius-6, paint);
